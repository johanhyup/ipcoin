...
<div class="main3">
    ...
    <div class="top_bar">
        ...
        <section>
            <span>유저 코인 락업 :</span><button class="rocktButton" type="button" onclick="openLockupForm()">락업하기</button>
        </section>
        <section>
        <span>유저 코인 락업 해제:</span><button class="rocktButton" type="button" onclick="openUnlockForm2()">락업 해제</button>
        </section>
        <br/>
    </div>
